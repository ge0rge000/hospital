...
class AppRoutes{
  ...
  static const doctorsscreen =Routes.doctorsscreen;
  ...
  GetPage(name: Routes.doctorsscreen, page:()=>  DoctrorsScreen(),bindings: [DoctorBinding()]),
